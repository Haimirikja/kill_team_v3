const TACOPS = [
    ...
    },
    {
        ...
        "missionAction": [
            {
                ...
                "effects": [
                    [
                        "Place your Banner mission marker within the active operative's control range, wholly within your opponent's territory and more than 5\" from a neutral killzone edge.",
                        "Operatives can perform the Pick Up Marker action on your Banner mission marker."
                    ]
                ],
                "conditions": [
                    [
        ...
        "victoryPoints": [
            "At the end of each turning point after the first, if your Banner mission marker is wholly within your opponent's territory and friendly operatives control it, you score 1VP; if that's true and no enemy operatives contest it, you score 2VP instead.",
            "Note your Banner mission marker must be in the killzone (not being carried) to score."
        ]
    },
    {
        "archetype": "Security",
